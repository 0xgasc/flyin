            ...
            >
              ...
              {hoveredIndex === index && (
                <div className="absolute inset-0 pointer-events-none z-30">
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250%] max-w-[500px] bg-white rounded-xl shadow-2xl overflow-hidden border-4 border-white">
                    <img
                      src={image.image_url}
                      alt={image.caption || 'FlyInGuate experience'}
