...
export default function DestinationSelectorModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end md:items-center justify-center p-0 md:p-4 z-50">
      <div className="bg-white rounded md:rounded shadow-xl w-full md:max-w-md max-h-[90vh] md:max-h-[80vh] overflow-hidden">
        {/* Header */}
              ...
              <div className="space-y-2">
                {department.airports.map((airport) => (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded border-2 transition-all touch-manipulation ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              {department.destinations.map((destination) => (
                <button
                  ...
                  className={`p-3 rounded border-2 transition-all touch-manipulation ${
